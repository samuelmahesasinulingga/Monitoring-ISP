...
const SLAReportSection: React.FC<SLAReportSectionProps> = ({ workspaceId }) => {
  ...
  return (
    <section className="max-w-5xl mx-auto">
      <header className="mb-4 flex items-center justify-between gap-3 flex-wrap print-hide">
        <div>
        ...
        <div className="flex gap-2 flex-wrap">
          <select
            ...
            className="px-3 py-2 rounded-xl border border-[var(--border-main)] text-[12px] bg-[var(--bg-main)] text-[var(--text-main-primary)] outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500/60 shadow-sm"
          >
          ...
          <select
            ...
            className="px-3 py-2 rounded-xl border border-[var(--border-main)] text-[12px] bg-[var(--bg-main)] text-[var(--text-main-primary)] min-w-[220px] outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500/60 shadow-sm"
          >
      ...
      {isLoading ? (
        ...
        <div className="grid gap-4 mb-4" style={{ gridTemplateColumns: "minmax(0, 1.3fr) minmax(0, 1fr)" }}>
          {/* Analisa SLA */}
          <div className="rounded-2xl p-5 bg-[var(--card-main-bg)] hover:-translate-y-1 hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-300 border border-[var(--border-main)] shadow-lg">
            ...
            <div className="flex items-center justify-between gap-6 mb-5 flex-wrap">
              <div className="bg-[var(--bg-main)] p-4 rounded-2xl border border-[var(--border-main)] flex-1 min-w-[140px]">
                <div className="text-[11px] font-bold text-[var(--text-main-secondary)] uppercase tracking-wider mb-1">
                  SLA SCORE
                </div>
                <div
              ...
              <div className="flex-1 min-w-[200px]">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="text-[12px] text-[var(--text-main-secondary)]">
                    Estimasi downtime: <span className="font-bold text-[var(--text-main-primary)]">{Math.floor(totalDowntimeMinutes / 60)} jam {totalDowntimeMinutes % 60} menit</span>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400" />
                  <div className="text-[12px] text-[var(--text-main-secondary)]">
                    Rata-rata Latensi: <span className="font-bold text-[var(--text-main-primary)]">{stats?.avgLatencyMs.toFixed(1)} ms</span>
                  </div>
                </div>
              </div>
            </div>

            <div className="rounded-2xl bg-[var(--bg-main)] border border-[var(--border-main)] px-4 py-4 text-[12px] text-[var(--text-main-secondary)] max-h-[220px] overflow-auto">
              <div className="text-[11px] uppercase tracking-[0.08em] font-bold text-[var(--text-main-secondary)] mb-3">
              ...
              {downtimeEvents.length > 0 ? (
                downtimeEvents.map((d, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between py-2 border-b border-[var(--border-main)] last:border-0"
                  >
                    <div>
                      <div className="font-bold text-[var(--text-main-primary)]">{d.date}</div>
                      <div className="text-[11px] text-[var(--text-main-secondary)]">{d.cause}</div>
                    </div>
          ...
          <div className="rounded-2xl p-5 bg-[var(--card-main-bg)] hover:-translate-y-1 hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-300 border border-[var(--border-main)] shadow-lg">
            ...
            <p className="m-0 text-[12px] text-[var(--text-main-secondary)] mb-5">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 border-t border-[var(--border-main)]">
                <button 
                  ...
                  className="w-full py-2.5 rounded-xl bg-blue-600 text-white text-[12px] font-bold hover:bg-blue-700 transition-all flex items-center justify-center gap-2 shadow-lg shadow-blue-500/20 print-hide"
                >
                  📥 Cetak Laporan SLA
                </button>
                <p className="mt-3 text-[11px] text-[var(--text-main-secondary)] text-center italic">
